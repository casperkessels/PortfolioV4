  ...
  return (
    <Layout>
      ...
      <div className="w-70-ns ph0-ns ph3 mt0 center vh-100">
        <div className="db mt5-ns mt3 mh-auto center" >
                  ...
                  <li key={node.id} className="dib w-100 center mt3" >
                    ...
                    >
                      <div class="flex flex-column flex-row-ns bg_nord6 br2 overflow-hidden grow">
                        ...
                        <div class="w-100 w-50-ns ph4 pv1-ns pv5 flex flex-column justify-center">
                          <h2 className="lh-title mb0 mt0 f4">{node.frontmatter.title}</h2>
                          <p className="lh-copy mb0 mt2 f6-ns f7 ">{node.frontmatter.subtitle}</p>
                          <p className=" mb0 mt2 f7 pt2 dib">{node.frontmatter.date} | {node.frontmatter.company}</p>
                        </div>
                      </div>
                    </Link>
                  </li>
      ...
      <div className="w-100 center h-auto">
        ...
        <div className="w-70-l w-90-m center ph0-ns ph2 center">
          ...
          <div className="tc w-100 nord0 center mv4 ">
            <div className="verticalLine tc center mb0">
              <br />
              <br />
            </div>
            <p className="pv4 mb0">Here are some of my side projects</p>
            <div className="verticalLine tc center mb0">
              <br />
              <br />
            </div>
          ...
          <div className="db v-top ph0 ml0 mt6 flex flex-column flex-row-ns">
            <div className="w-50-ns w-100center grow mr0 mr3-ns mb3 mb0-ns" >
              <a href="https://theturnsignalblog.com" target="_blank" rel="noopener noreferrer" className="no-underline nord0">
                <div className="relative" >
                  <div className=" overflow-hidden">
                    <img className="br2 h5 w-100 object-fit-cover mb0" src={turnsignal} alt="The Turn Signal" />
                  </div>
                  <div className="pb3 ph2">
                    <h2 className="lh-title mb0 f4 f5-ns mt2 nord0">The Turn Signal Blog</h2>
                    <p className="lh-copy mb0 mt2 f6-ns f7 ">My blog about automotive UX design where I publish an article (almost) each month. I developed the blog from scratch with React and Gatsby.</p>
                  </div>
                </div>
              </a>
            </div>
              ...
              <a href="https://cardesignhistory.com" target="_blank" rel="noopener noreferrer" className="no-underline nord0">
                <div className="relative" >
                  <div className="br2 overflow-hidden ">
                    <img className="h5 w-100 br2 object-fit-cover mb0" src={cardesignhistory} alt="Car Design History" />
                  </div>
                  <div className="pb3 ph2">
                    <h2 className="lh-title mb0 f4 f5-ns mt2 nord0">Car Design History</h2>
                    <p className="lh-copy mb0 mt2 f6-ns f7 ">An interactive data visualization showing the evolution of Italian car design. I designed and collected the data myself and then developed it in D3js.</p>
                  </div>
                </div>
              </a>
            </div>

           {/* <div className="w-50-ns w-100 center grow" >
              <Link
                to={`/photography/`}
                className="no-underline nord0"
              >
      ...
      <div className="w-100 center h-auto mb6">
        ...
        <div className="w-70-l w-90-m center ph0-ns ph2 center">
          ...
          <div className="tc w-100 nord0 center mv5 ">
            <div className="verticalLine tc center mb0">
              <br />
              <br />
            </div>
            <p className="pv4 mb0">I occasionally like to write, here are my recent articles:</p>
            <div className="verticalLine tc center mb0">
              <br />
              <br />
            </div>
